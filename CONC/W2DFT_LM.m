...
for i = 1 : NFFT_omega
    for j = 1 : NFFT_eta
        ...
        deta_deta = -real((F_drwRwT(j,i)*F_wRwT(j,i) - F_dwRwT(j,i)*F_rwRwT(j,i))/(F_wRwT(j,i)^2));
        deta_domega   = -real((F_dwRtwT(j,i)*F_wRwT(j,i) - F_dwRwT(j,i)*F_wRtwT(j,i))/(F_wRwT(j,i)^2));
        domega_deta   = -real((F_rwRdwT(j,i)*F_wRwT(j,i) - F_wRdwT(j,i)*F_rwRwT(j,i))/(F_wRwT(j,i)^2));
        domega_domega     = -real((F_wRdtwT(j,i)*F_wRwT(j,i) - F_wRdwT(j,i)*F_wRtwT(j,i))/(F_wRwT(j,i)^2));
